    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header bg-white">
          ...
          <div class="row">
            <div class="col-10">
              <h6 class="card-subtitle">Aqui estão listados todas as suas <code class="highlighter-rouge">taxas por menu,</code> basta inserir alguma informação de taxa no campo de busca, para filtrar pela taxa expecifica.</code></h6>
            </div>
